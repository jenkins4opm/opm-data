# - The eWoms simulation framework for flow  and transport in porous media config mode
#
# Defines the following variables:
#  ewoms_FOUND        - true
#  ewoms_VERSION      - version of the ewoms library found, e.g. 0.2
#  ewoms_DEFINITIONS  - defines to be made on the command line
#  ewoms_INCLUDE_DIRS - header directories with which to compile
#  ewoms_LINKER_FLAGS - flags that must be passed to the linker
#  ewoms_LIBRARIES    - names of the libraries with which to link
#  ewoms_LIBRARY_DIRS - directories in which the libraries are situated
#
# You should put lines like this in your CMakeLists.txt
#  set (ewoms_DIR "${PROJECT_BINARY_DIR}/../ewoms" CACHE LOCATION "Build tree of ewoms")
#  find_package (ewoms)
#  configure_vars (
#    FILE  CXX  "${PROJECT_BINARY_DIR}/config.h"
#    WRITE ${ewoms_CONFIG_VARS}
#    )
...
if(NOT ewoms_FOUND)
  ...
  set (ewoms_VERSION "2018.04")
  set (ewoms_DEFINITIONS "-DDUNE_COMMON_FIELDVECTOR_SIZE_IS_METHOD=1;-DHAVE_OPM_GRID")
  set (ewoms_INCLUDE_DIRS "/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/include;/usr/include;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/suitesparse;/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/include;/usr/local/include;/usr/include/trilinos")
  set (ewoms_LIBRARY_DIRS "/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/lib/x86_64-linux-gnu")
  set (ewoms_LINKER_FLAGS "-Wl,--enable-new-dtags")
  set (ewoms_CONFIG_VARS "HAS_ATTRIBUTE_UNUSED;HAS_ATTRIBUTE_DEPRECATED;HAS_ATTRIBUTE_DEPRECATED_MSG;HAVE_ARRAY;HAVE_BOOST_MAKE_SHARED_HPP;HAVE_BOOST_SHARED_PTR_HPP;HAVE_DUNE_BOOST;HAVE_GMP;HAVE_MAKE_SHARED;HAVE_MPI;HAVE_NULLPTR;HAVE_STATIC_ASSERT;HAVE_SHARED_PTR;MPI_2;SHARED_PTR_HEADER;SHARED_PTR_NAMESPACE;HAVE_TYPE_TRAITS;HAVE_TR1_TUPLE;HAVE_TUPLE;HAVE_CXA_DEMANGLE;HAVE_ALGLIB;HAVE_UG;HAVE_DUNE_FEM;HAVE_GRIDTYPE;HAVE_GRAPE;HAVE_PSURFACE;HAVE_AMIRAMESH;HAVE_ALBERTA;HAVE_STDINT_H;DUNE_GRID_EXPERIMENTAL_GRID_EXTENSIONS;HAVE_BOOST_FUSION;HAVE_MEM_USAGE_T_EXPANSIONS;HAVE_PARDISO;HAVE_BOOST;HAVE_PARMETIS;HAVE_SUPERLU;HAVE_UMFPACK;SUPERLU_MIN_VERSION_4_3;SUPERLU_POST_2005_VERSION;HAVE_OPM_PARSER;HAVE_REGEX;HAVE_ERT;HAVE_VALGRIND;HAVE_FINAL;DUNE_GRID_VERSION_MAJOR;DUNE_GRID_VERSION_MINOR;DUNE_GRID_VERSION_REVISION;DUNE_GEOMETRY_VERSION_MAJOR;DUNE_GEOMETRY_VERSION_MINOR;DUNE_GEOMETRY_VERSION_REVISION;DUNE_COMMON_VERSION_MAJOR;DUNE_COMMON_VERSION_MINOR;DUNE_COMMON_VERSION_REVISION;HAVE_DUNE_ISTL;HAVE_ZOLTAN;HAVE_SUITESPARSE_UMFPACK_H;HAVE_PETSC;DUNE_ISTL_VERSION_MAJOR;DUNE_ISTL_VERSION_MINOR;DUNE_ISTL_VERSION_REVISION;HAVE_QUAD;HAVE_VALGRIND;HAVE_DUNE_COMMON;HAVE_DUNE_GEOMETRY;HAVE_DUNE_GRID;HAVE_DUNE_LOCALFUNCTIONS;HAVE_DUNE_ISTL;HAVE_DUNE_ALUGRID;HAVE_DUNE_FEM;DUNE_AVOID_CAPABILITIES_IS_PARALLEL_DEPRECATION_WARNING")

  # libraries come from the build tree where this file was generated
  set (ewoms_LIBRARY "")
  set (ewoms_LIBRARIES ${ewoms_LIBRARY} "/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/lib/x86_64-linux-gnu/libopmcore.a;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/lib/x86_64-linux-gnu/libopmoutput.a;/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/lib/x86_64-linux-gnu/libopmgrid.a;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;dunegrid;dunealbertagrid_1d;dunealbertagrid_2d;dunealbertagrid_3d;dunegeometry;dunecommon;/usr/lib/x86_64-linux-gnu/openmpi/lib/libmpi_cxx.so;/usr/lib/x86_64-linux-gnu/openmpi/lib/libmpi.so;/usr/lib/x86_64-linux-gnu/libumfpack.so;/usr/lib/x86_64-linux-gnu/libamd.so;/usr/lib/liblapack.so;/usr/lib/libblas.so;/usr/lib/x86_64-linux-gnu/libm.so;/usr/lib/x86_64-linux-gnu/libsuitesparseconfig.so;-lrt;/var/lib/jenkins/workspace/opm-simulators-PR-builder/mpi/install/lib/x86_64-linux-gnu/libopmcommon.a;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_system.so;opmparser;/usr/lib/x86_64-linux-gnu/libtrilinos_zoltan.so")
  mark_as_advanced (ewoms_LIBRARY)
  ...
  if (NOT "" STREQUAL "")
    ...
    set_property (TARGET  PROPERTY IMPORTED_LOCATION "${ewoms_LIBRARY}")
  endif (NOT "" STREQUAL "")
